        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <div className={`mb-12 flex flex-col items-center text-center relative z-10 ${uiMode === 'classic' ? 'pt-10' : ''}`}>
                <div className="relative group mb-8 w-64 h-64 flex items-center justify-center">
                    {uiMode === 'modern' && (
                        <div className="absolute -inset-4 bg-gradient-to-r from-primary to-secondary opacity-20 blur-2xl group-hover:opacity-40 transition-opacity z-0 pointer-events-none"></div>
                    )}
                    <img 
                ...
                {uiMode === 'modern' && setParticleSettings && particleSettings && (
                    <div className="w-full max-w-sm mx-auto flex flex-col items-center relative z-10">
                        <button 
                            ...
                            className="text-xs text-slate-400 hover:text-white uppercase tracking-widest font-bold flex items-center gap-2 transition-colors mb-4 bg-black/40 px-4 py-2 rounded-full backdrop-blur-md border border-white/10"
                        >
