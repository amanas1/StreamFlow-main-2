...
export const GENRES: CategoryInfo[] = [
    { id: 'hiphop', name: 'Hip-Hop', color: 'from-yellow-600 to-amber-900', description: 'Rhythm, flow, storytelling.', type: 'genre' },
    { id: 'rnb', name: 'R&B', color: 'from-violet-500 to-fuchsia-600', description: 'Rhythm and Blues, soulful and smooth.', type: 'genre' },
    { id: 'pop', name: 'Pop', color: 'from-pink-600 to-rose-900', description: 'Catchy melodies, modern hits.', type: 'genre' },
    { id: 'rock', name: 'Rock', color: 'from-red-600 to-pink-900', description: 'Guitars, drums, energy.', type: 'genre' },
    { id: 'indie', name: 'Indie', color: 'from-emerald-500 to-teal-700', description: 'Independent spirit and unique sounds.', type: 'genre' },
    { id: 'edm', name: 'EDM', color: 'from-cyan-500 to-blue-700', description: 'Electronic Dance Music for the club.', type: 'genre' },
    { id: 'house', name: 'House', color: 'from-blue-600 to-indigo-900', description: 'Steady beats and soulful grooves.', type: 'genre' },
    { id: 'deephouse', name: 'Deep House', color: 'from-indigo-800 to-black', description: 'Smooth, deep, and atmospheric house.', type: 'genre' },
    { id: 'techno', name: 'Techno', color: 'from-slate-700 to-slate-900', description: 'Industrial rhythms and synth textures.', type: 'genre' },
    { id: 'trance', name: 'Trance', color: 'from-purple-600 to-blue-800', description: 'Hypnotic melodies and uplifting energy.', type: 'genre' },
    { id: 'dnb', name: 'Drum & Bass', color: 'from-orange-700 to-red-900', description: 'High-speed breaks and heavy basslines.', type: 'genre' },
    { id: 'jazz', name: 'Jazz', color: 'from-amber-600 to-orange-900', description: 'Smooth, soulful improvisation.', type: 'genre' },
    { id: 'blues', name: 'Blues', color: 'from-indigo-600 to-purple-900', description: 'Deep emotions, raw vocals.', type: 'genre' },
    { id: 'classical', name: 'Classical', color: 'from-violet-600 to-indigo-900', description: 'Timeless symphonies, orchestral masterpieces.', type: 'genre' },
    { id: 'instrumental', name: 'Instrumental', color: 'from-teal-600 to-cyan-900', description: 'Music without words, pure instruments.', type: 'genre' },
    { id: 'lofi', name: 'Lo-fi', color: 'from-stone-600 to-stone-800', description: 'Low-fidelity beats for study and chill.', type: 'genre' },
    { id: 'chillout', name: 'Chillout', color: 'from-sky-500 to-blue-700', description: 'Relaxing sounds for winding down.', type: 'genre' },
    { id: 'lounge', name: 'Lounge', color: 'from-rose-500 to-amber-700', description: 'Sophisticated background music.', type: 'genre' },
    { id: 'latin', name: 'Latin', color: 'from-orange-500 to-red-600', description: 'Vibrant rhythms from Latin America.', type: 'genre' },
    { id: 'reggaeton', name: 'Reggaeton', color: 'from-yellow-400 to-red-500', description: 'Urban Latin beats and energy.', type: 'genre' },
    { id: 'afrobeat', name: 'Afrobeat', color: 'from-orange-600 to-green-800', description: 'Fusion of African sounds and jazz.', type: 'genre' },
    { id: 'kpop', name: 'K-pop', color: 'from-pink-400 to-fuchsia-500', description: 'Korean pop global phenomenon.', type: 'genre' },
    { id: 'jpop', name: 'J-pop', color: 'from-red-400 to-rose-500', description: 'J-Pop energy and melodies.', type: 'genre' },
    { id: 'synthwave', name: 'Synthwave', color: 'from-fuchsia-600 to-indigo-800', description: '80s inspired retro-future sounds.', type: 'genre' },
    { id: 'disco', name: 'Disco', color: 'from-purple-500 to-pink-500', description: '70s dance floor classics.', type: 'genre' },
    { id: 'funk', name: 'Funk', color: 'from-yellow-500 to-orange-600', description: 'Groovy bass and soulful rhythms.', type: 'genre' },
    { id: 'soul', name: 'Soul', color: 'from-rose-400 to-orange-400', description: 'Deeply emotional vocal music.', type: 'genre' },
    { id: 'alternative', name: 'Alternative', color: 'from-zinc-600 to-zinc-900', description: 'Non-mainstream rock and indie.', type: 'genre' },
    { id: 'ambient', name: 'Ambient', color: 'from-blue-900 to-black', description: 'Atmospheric and soundscape driven.', type: 'genre' }
];
...
export const TRANSLATIONS: Record<string, any> = {
    en: {
        ...
        next: 'Next', gotIt: 'Got it', manualTitle: 'User Manual', manualIntro: 'Welcome to AU Radio, your ultimate radio experience.', 
        ...
        playingNow: 'Playing Now', listenNow: 'Listen Now', aboutStation: 'About the Station', technicalInfo: 'Technical Info',
        ...
        classicView: 'Classic View', modernView: 'Modern View',
    },
    ru: {
        ...
        next: 'Далее', gotIt: 'Понятно', manualTitle: 'Руководство', manualIntro: 'Добро пожаловать в AU Radio — ваш идеальный радио-опыт.', 
        ...
        playingNow: 'В эфире', listenNow: 'Слушать', aboutStation: 'О станции', technicalInfo: 'Характеристики',
        ...
        classicView: 'Классика', modernView: 'Модерн',
    },
    es: {
        ...
        next: 'Siguiente', gotIt: 'Entendido', manualTitle: 'Manual de usuario', manualIntro: 'Bienvenido a AU Radio, tu experiencia de radio definitiva.', 
    ...
    fr: {
        ...
        next: 'Suivant', gotIt: 'Compris', manualTitle: 'Manuel d’utilisation', manualIntro: 'Bienvenue sur AU Radio, votre expérience radio ultime.', 
    ...
    zh: {
        ...
        next: '下一步', gotIt: '知道了', manualTitle: '用户手册', manualIntro: '欢迎来到 AU Radio，您的终极广播体验。', 
    ...
    de: {
        ...
        next: 'Weiter', gotIt: 'Verstanden', manualTitle: 'Handbuch', manualIntro: 'Willkommen bei AU Radio, Ihrem ultimativen Radio-Erlebnis.', 
