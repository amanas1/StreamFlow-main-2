              ...
              <section id="section-chat_manual" className="space-y-16 scroll-mt-20">
                  ...
                  <div className="border-t border-white/5 pt-12 space-y-12">
                      <div className="space-y-6">
                          ...
                          {/* CHAPTER 1: THE CLOUD TRAP */}
                          <div className="space-y-6 mt-8">
                              <h4 className="text-2xl font-bold text-red-400 flex items-center gap-3">
                                  <span className="text-3xl">🛑</span> Глава 1. Ловушка "Облака"
                              </h4>
                              <div className="prose prose-invert max-w-none text-slate-300 leading-8 font-light text-lg">
                                  <p>
                                      Вы привыкли к удобству. Вы пишете сообщение с телефона, а через секунду видите его на ноутбуке. Вы меняете телефон, вводите код, и вся история переписки за 5 лет восстанавливается из ниоткуда. 
                                      <br/><br/>
                                      <strong>Удобно?</strong> Безусловно.
                                      <br/>
                                      <strong>Безопасно?</strong> Абсолютно нет.
                                  </p>
                                  <p>
                                      Чтобы обеспечить это "удобство", корпорации (Telegram, WhatsApp, Facebook) вынуждены хранить <strong>ПЕТАБАЙТЫ</strong> ваших логов. Даже если они заявляют о "сквозном шифровании" (E2EE), они лукавят. Они видят <em>Metadata</em>.
                                  </p>
                                  <div className="my-8 p-6 bg-red-900/10 border-l-4 border-red-500 italic text-slate-400">
                                      "Метаданные — это записка на конверте. Почтальон может не читать письмо внутри, но он точно знает, ОТ КОГО оно, КОМУ оно адресовано, и КОГДА оно было отправлено. Соберите миллиард таких конвертов, и вы будете знать о жизни людей больше, чем они сами."
                                  </div>
                                  <p>
                                      Коммерческие мессенджеры строят "Граф Связей" (Social Graph). Они знают, что в 23:45 вы пишете определенному контакту. Это стоит миллиарды долларов для рекламных бирж.
                                  </p>
                              </div>
                          </div>
