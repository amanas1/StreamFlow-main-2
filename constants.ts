...
export const DEMO_USERS: UserProfile[] = [
    ...
    { id: 'd6', name: 'Liam', avatar: 'https://i.pravatar.cc/150?u=16', age: 26, country: 'UK', city: 'London', status: 'offline', safetyLevel: 'green', bio: '', gender: 'male', blockedUsers: [], hasAgreedToRules: true, filters: { minAge: 18, maxAge: 99, countries: [], languages: [], genders: ['any'], soundEnabled: true }, chatSettings: { notificationsEnabled: true, notificationVolume: 0.8, notificationSound: 'default', bannerNotificationsEnabled: true, voiceNotificationsEnabled: false, notificationVoice: 'female' } },
...
export const TRANSLATIONS: Record<string, any> = {
    ...
    es: {
        ...
        jazz: 'Jazz', blues: 'Blues', rock: 'Rock', classical: 'Clásica', electronic: 'Electrónica', hiphop: 'Hip Hop', pop: 'Pop', rnb: 'R&B', reggae: 'Reggae', soul: 'Soul',
        '60s': '60s', '70s': '70s', '80s': '80s', '90s': '90s', '00s': '00s', '10s': '10s', '20s': '20s',
    ...
    fr: {
        ...
        jazz: 'Jazz', blues: 'Blues', rock: 'Rock', classical: 'Classique', electronic: 'Électronique', hiphop: 'Hip Hop', pop: 'Pop', rnb: 'R&B', reggae: 'Reggae', soul: 'Soul',
        '60s': '60s', '70s': '70s', '80s': '80s', '90s': '90s', '00s': '00s', '10s': '10s', '20s': '20s',
    ...
    zh: {
        ...
        spatialMixer: '空间混合器',
        jazz: '爵士', blues: '布鲁斯', rock: '摇滚', classical: '古典', electronic: '电子', hiphop: '嘻哈', pop: '流行', rnb: 'R&B', reggae: '雷鬼', soul: '灵魂乐',
    ...
    de: {
        ...
        jazz: 'Jazz', blues: 'Blues', rock: 'Rock', classical: 'Klassik', electronic: 'Elektronik', hiphop: 'Hip Hop', pop: 'Pop', rnb: 'R&B', reggae: 'Reggae', soul: 'Soul',
